...
for (const token of tokens) {
    if (token.document.getFlag(SCOPE, FLAG_NAME)) {
        ...
        let data = {
            "texture.src": "modules/dhtr/icons/tokens/Rubble_Pile_Stone_Earthy_A3_2x2.png",
            "texture.scaleX": token.document.texture.scaleX * 0.5,
            "texture.scaleY": token.document.texture.scaleY * 0.5
        }
